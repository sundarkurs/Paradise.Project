...
{
    public class AspNetIdentityUserService_backup<TUser, TKey> : UserServiceBase
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public AspNetIdentityUserService_backup(UserManager<TUser, TKey> userManager, Func<string, TKey> parseSubject = null)
        {
